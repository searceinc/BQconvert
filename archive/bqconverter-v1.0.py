...
parser.add_argument('-r', '--bq_project', dest='bq_project', action='store', help="Bigquery project name")
parser.add_argument('-l', '--bq_location', dest='bq_location', action='store',  help="Bigquery dataset location")
parser.add_argument('-D', '--bq_dataset', dest='bq_dataset', action='store', help="Bigquery dataset name")
